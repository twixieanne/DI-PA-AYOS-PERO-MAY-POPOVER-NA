...
$(document).ready(function () {
  // Function to toggle the visibility of the popovers
  function togglePopover(popoverId) {
    const popover = $("#" + popoverId);

    // Toggle the visibility by adding/removing the "show" class
    if (popover.hasClass("show")) {
      popover.addClass("show"); // Hide the popover
    } else {
      popover.removeClass("show"); // Show the popover
    }

    // Hide all other popovers that are not the current one
    $(".popover").not(popover).removeClass("show");
  }

  // When the Armor button is clicked, toggle the armor popover
  $("#armbtn").click(function () {
    togglePopover('armorPopover'); // Toggle the armor popover
  });

  // When the Arrow button is clicked, toggle the arrow popover
  $("#arbtn").click(function () {
    togglePopover('arrowPopover'); // Toggle the arrow popover
  });

  // When the Sword button is clicked, toggle the sword popover
  $("#swbtn").click(function () {
    togglePopover('swordPopover'); // Toggle the sword popover
  });
});
